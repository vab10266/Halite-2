...
public class V5 {
    ...
    final static double emptyValue = 3.0;
    final static double fullValue = 0.0;

    public static void main(final String[] args) {
        final Networking networking = new Networking();
        final GameMap gameMap = networking.initialize("V5");
        ...
        while (true) {
            ...
            for (Ship s : gameMap.getMyPlayer().getShips().values()) {
                ...
                for (Planet p : planets) {
                    ...
                    double value = p.getDockingSpots() * dockingValue / (s.getDistanceTo(p) * distanceValue);
